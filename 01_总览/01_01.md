...
### 7.3.1 **基本版 - 客户端使用 OTLP 进行检测，将数据发送到一组收集器。**
...
### 7.3.2 **在** **Kubernetes** **上部署 OpenTelemetry Collector 时可以使用的模式**
...
![](image/d42815b3801ee81f2c61d66af2ea05cf.png)


### 7.3.3 其他

[负载均衡](https://cloud.tencent.com/product/clb?from_column=20065&from=20065) - 基于 trace id 的负载均衡：
![](image/4990eaebf8922c1b5209ffff7a596d2b.png)




多集群 - 代理、工作负载和控制平面收集器：
![](image/a84420dbb36d2261ea73394e36456084.png)



**多租户模式**
两个租户，每个租户都有自己的 Jaeger。
![](image/0154d2c81f8fe60d42f4eb1445e05a7d.png)
...
![](image/1091f78801aa44a1a02529ae0131dc91.png)
